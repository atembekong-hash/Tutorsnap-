...
var subscriptionStatusEnum = (0, import_pg_core.pgEnum)("subscription_status", ["active", "cancelled", "expired", "refunded"]);
var classroomRoleEnum = (0, import_pg_core.pgEnum)("classroom_role", ["teacher", "learner"]);
var assignmentStatusEnum = (0, import_pg_core.pgEnum)("assignment_status", ["draft", "published"]);
var submissionStatusEnum = (0, import_pg_core.pgEnum)("submission_status", ["pending", "complete"]);
...
var referralCodes = (0, import_pg_core.pgTable)("referral_codes", {
  id: (0, import_pg_core.integer)("id").generatedAlwaysAsIdentity().primaryKey(),
...
var fraudAlerts = (0, import_pg_core.pgTable)("fraud_alerts", {
  id: (0, import_pg_core.integer)("id").generatedAlwaysAsIdentity().primaryKey(),
...
var redemptionHistory = (0, import_pg_core.pgTable)("redemption_history", {
  id: (0, import_pg_core.integer)("id").generatedAlwaysAsIdentity().primaryKey(),
  userId: (0, import_pg_core.integer)("userId").references(() => users.id, { onDelete: "cascade" }),
...
var otpCodes = (0, import_pg_core.pgTable)(
  "otp_codes",
  {
    id: (0, import_pg_core.integer)("id").generatedAlwaysAsIdentity().primaryKey(),
  ...
  (t) => ({
    idxEmailPurpose: (0, import_pg_core.index)("idx_otp_email_purpose").on(t.email, t.purpose, t.createdAt),
    idxExpires: (0, import_pg_core.index)("idx_otp_expires").on(t.expiresAt)
  })
);
var otpAudit = (0, import_pg_core.pgTable)(
  "otp_audit",
  {
    id: (0, import_pg_core.integer)("id").generatedAlwaysAsIdentity().primaryKey(),
  ...
  (t) => ({
    idxAuditEmailCreated: (0, import_pg_core.index)("idx_audit_email_created").on(t.email, t.createdAt),
    idxAuditIpCreated: (0, import_pg_core.index)("idx_audit_ip_created").on(t.ipAddress, t.createdAt)
  })
);
var schedulerLocks = (0, import_pg_core.pgTable)("scheduler_locks", {
...
var aireFeedback = (0, import_pg_core.pgTable)(
  "aire_feedback",
  {
    id: (0, import_pg_core.integer)("id").generatedAlwaysAsIdentity().primaryKey(),
    userId: (0, import_pg_core.integer)("userId").references(() => users.id, { onDelete: "cascade" }),
  ...
  (t) => [(0, import_pg_core.index)("aire_feedback_userId_idx").on(t.userId)]
);
var aireSubjectCalibration = (0, import_pg_core.pgTable)(
  ...
  (t) => [
    (0, import_pg_core.index)("aire_calib_userId_subject_idx").on(t.userId, t.subject)
  ]
);
var solveHistory = (0, import_pg_core.pgTable)(
  "solve_history",
  {
    id: (0, import_pg_core.integer)("id").generatedAlwaysAsIdentity().primaryKey(),
    userId: (0, import_pg_core.integer)("userId").notNull().references(() => users.id, { onDelete: "cascade" }),
  ...
  (t) => [(0, import_pg_core.index)("solve_history_userId_idx").on(t.userId, t.solvedAt)]
);
var chatSessions = (0, import_pg_core.pgTable)(
  "chat_sessions",
  {
    id: (0, import_pg_core.integer)("id").generatedAlwaysAsIdentity().primaryKey(),
    userId: (0, import_pg_core.integer)("userId").notNull().references(() => users.id, { onDelete: "cascade" }),
  ...
  (t) => [
    (0, import_pg_core.index)("chat_sessions_userId_idx").on(t.userId),
    (0, import_pg_core.index)("chat_sessions_sessionId_idx").on(t.userId, t.sessionId)
  ]
);
var userProgress = (0, import_pg_core.pgTable)("user_progress", {
  id: (0, import_pg_core.integer)("id").generatedAlwaysAsIdentity().primaryKey(),
...
var userBookmarks = (0, import_pg_core.pgTable)(
  "user_bookmarks",
  {
    id: (0, import_pg_core.integer)("id").generatedAlwaysAsIdentity().primaryKey(),
    userId: (0, import_pg_core.integer)("userId").notNull().references(() => users.id, { onDelete: "cascade" }),
  ...
  (t) => [
    (0, import_pg_core.index)("user_bookmarks_userId_idx").on(t.userId),
    (0, import_pg_core.index)("user_bookmarks_bookmarkId_idx").on(t.userId, t.bookmarkId)
  ]
);
var userNotes = (0, import_pg_core.pgTable)(
  "user_notes",
  {
    id: (0, import_pg_core.integer)("id").generatedAlwaysAsIdentity().primaryKey(),
    userId: (0, import_pg_core.integer)("userId").notNull().references(() => users.id, { onDelete: "cascade" }),
  ...
  (t) => [
    (0, import_pg_core.index)("user_notes_userId_idx").on(t.userId),
    (0, import_pg_core.index)("user_notes_noteId_idx").on(t.userId, t.noteId)
  ]
);
var subscriptions = (0, import_pg_core.pgTable)(
  "subscriptions",
  {
    id: (0, import_pg_core.integer)("id").generatedAlwaysAsIdentity().primaryKey(),
  ...
  (t) => [
    (0, import_pg_core.index)("idx_subscriptions_userId").on(t.userId),
    (0, import_pg_core.index)("idx_subscriptions_rcUserId").on(t.revenueCatUserId)
  ]
);
var classrooms = (0, import_pg_core.pgTable)(
  "classrooms",
  {
    id: (0, import_pg_core.integer)("id").generatedAlwaysAsIdentity().primaryKey(),
  ...
  (t) => [
    (0, import_pg_core.index)("classrooms_teacher_idx").on(t.teacherId),
    (0, import_pg_core.index)("classrooms_active_updated_idx").on(t.isActive, t.updatedAt)
  ]
);
var classroomMembers = (0, import_pg_core.pgTable)(
  "classroom_members",
  {
    id: (0, import_pg_core.integer)("id").generatedAlwaysAsIdentity().primaryKey(),
  ...
  (t) => [
    (0, import_pg_core.uniqueIndex)("classroom_members_class_user_uq").on(t.classroomId, t.userId),
    (0, import_pg_core.index)("classroom_members_user_joined_idx").on(t.userId, t.joinedAt),
    (0, import_pg_core.index)("classroom_members_class_role_idx").on(t.classroomId, t.role)
  ]
);
var assignments = (0, import_pg_core.pgTable)(
  "assignments",
  {
    id: (0, import_pg_core.integer)("id").generatedAlwaysAsIdentity().primaryKey(),
    publicId: (0, import_pg_core.varchar)("publicId", { length: 36 }).notNull().unique(),
  ...
  (t) => [
    (0, import_pg_core.index)("assignments_class_status_due_idx").on(t.classroomId, t.status, t.dueAt),
    (0, import_pg_core.index)("assignments_class_updated_idx").on(t.classroomId, t.updatedAt)
  ]
);
var assignmentSubmissions = (0, import_pg_core.pgTable)(
  ...
  (t) => [
    (0, import_pg_core.uniqueIndex)("assignment_submissions_assignment_user_uq").on(t.assignmentId, t.userId),
    (0, import_pg_core.index)("assignment_submissions_status_idx").on(t.assignmentId, t.status),
    (0, import_pg_core.index)("assignment_submissions_user_updated_idx").on(t.userId, t.updatedAt)
  ]
);
var assignmentComments = (0, import_pg_core.pgTable)(
  "assignment_comments",
  {
    id: (0, import_pg_core.integer)("id").generatedAlwaysAsIdentity().primaryKey(),
    publicId: (0, import_pg_core.varchar)("publicId", { length: 36 }).notNull().unique(),
  ...
  (t) => [
    (0, import_pg_core.index)("assignment_comments_assignment_created_idx").on(t.assignmentId, t.createdAt, t.id),
    (0, import_pg_core.index)("assignment_comments_author_created_idx").on(t.authorUserId, t.createdAt)
  ]
);
var classroomJoinAttempts = (0, import_pg_core.pgTable)(
  ...
  (t) => [
    (0, import_pg_core.index)("classroom_join_user_created_idx").on(t.userId, t.createdAt),
    (0, import_pg_core.index)("classroom_join_ip_created_idx").on(t.ipAddress, t.createdAt),
    (0, import_pg_core.index)("classroom_join_hash_created_idx").on(t.codeHash, t.createdAt)
  ]
);
